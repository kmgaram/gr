...
<?php
    ...
    $sql = "insert into gr_memberboard(name, subject, content, regist_day,";
    $sql .= "file_name, file_type, file_copied) values";
    $sql .= "('$username', '$subject', '$content', '$regist_day',";
    ...
    // 목록 페이지로 이동
    echo "<script>
        location.href = 'memberboard_list.php';
        </script>";
?>